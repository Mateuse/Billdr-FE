...
import { UI_TEXT, TABLE_HEADERS } from '../../constants/messages';
...
export const InvoiceSummary: React.FC<InvoiceSummaryProps> = ({
  ...
  return (
    <div>
      ...
      <Text size={SIZES.SM} c="dimmed">
        {TABLE_HEADERS.AMOUNT_PAID}: <Text component={INPUT_PROPERTIES.SPAN} fw={FONT_WEIGHTS.SEMIBOLD}>{INPUT_PROPERTIES.CURRENCY_SYMBOL}{Number(invoice.amount_paid).toFixed(2)}</Text>
      </Text>
